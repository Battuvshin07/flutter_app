  ...
  Future<void> seedSampleData() async {
    ...
    final stories = [
      {
        ...
        'xpReward': 100,
        'quickFacts': [
          'Чингис хааны жинхэнэ нэр Тэмүжин байсан',
          '1206 онд Их хурилтайд "Чингис хаан" цол хүртсэн',
          'Их засаг хууль нь Монголын анхны бичмэл хууль байв',
          'Мянгатын тогтолцоо нь овгийн тогтолцоог орлосон',
        ],
        'didYouKnow':
            'Чингис хааны "Их засаг" хуулинд шашин шүтэх эрх чөлөөг баталгаажуулсан бөгөөд энэ нь дэлхийн түүхэнд анхны шашны эрх чөлөөний баримт бичгүүдийн нэг юм.',
        'timeline': [
          {'year': '1162', 'event': 'Тэмүжин төрсөн'},
          {
            'year': '1189',
            'event': 'Хэрэйдийн Тоорил хаантай холбоо байгуулсан'
          },
          {'year': '1206', 'event': 'Их хурилтайд Чингис хаан өргөмжлөгдсөн'},
          {'year': '1206', 'event': 'Их засаг хууль тогтоосон'},
        ],
      },
      {
        'id': 'story_2',
        ...
        'xpReward': 120,
        'quickFacts': [
          'Монгол морьтон цэрэг өдөрт 100 км хүртэл нүүдэллэх чадвартай байсан',
          'Хорезмийн аян дайнд 200,000 цэрэг оролцсон',
          'Бээжинг бүслэн авахад нэг жил зарцуулсан',
          'Тагнуулын сүлжээ нь дэлхийн хамгийн өргөн байсан',
        ],
        'didYouKnow':
            'Монголчууд дайны үед хуурамч цэрэг ашиглаж, дайсныг төөрөгдүүлэх тактик хэрэглэдэг байв. Нэг морин цэрэг 3-5 нөөц морьтой явдаг байсан тул хэдэн зуун километрийг маш хурдан туулдаг байжээ.',
        'timeline': [
          {'year': '1209', 'event': 'Тангудын (Си Ся) улсыг дагуулсан'},
          {'year': '1211', 'event': 'Жин улс руу дайн зарласан'},
          {'year': '1215', 'event': 'Бээжин хотыг эзэлсэн'},
          {'year': '1219', 'event': 'Хорезм руу баруун аян дайн эхэлсэн'},
          {'year': '1221', 'event': 'Самарканд, Бухар эзлэгдсэн'},
        ],
      },
      {
        'id': 'story_3',
        ...
        'xpReward': 130,
        'quickFacts': [
          'Өгөдэй хааны үед нийслэл Хархорум хотыг барьсан',
          'Бат хааны баруун аян дайн Европыг айдаст автуулсан',
          'Гүрэн дөрвөн хаант улсад хуваагдсан',
          'Их Монгол Улс түүхэн дэх хамгийн том эзэнт гүрэн байв',
        ],
        'didYouKnow':
            'Бат хааны цэрэг 1241 онд Лигниц ба Мохийн тулалдаанд Европын рыцаруудыг ялж, Европчууд "Бурханы ташуур" гэж нэрлэсэн юм. Зөвхөн Өгөдэй хааны нас барсны мэдээ ирснээр Европ руу цааш довтолсонгүй.',
        'timeline': [
          {'year': '1227', 'event': 'Чингис хаан нас барсан'},
          {'year': '1229', 'event': 'Өгөдэй хааныг Их хурилтайд сонгосон'},
          {'year': '1235', 'event': 'Хархорум нийслэлийг барьсан'},
          {'year': '1237', 'event': 'Бат хааны баруун аян дайн эхэлсэн'},
          {
            'year': '1241',
            'event': 'Өгөдэй хаан нас барсан, Европ аян зогссон'
          },
          {'year': '1260', 'event': 'Гүрэн хаант улсуудад хуваагдаж эхэлсэн'},
        ],
      },
      {
        'id': 'story_4',
        ...
        'xpReward': 140,
        'quickFacts': [
          'Хубилай хаан Хятадыг бүхэлд нь нэгтгэсэн анхны монгол хаан',
          'Хаанбалиг (Бээжин) нь дэлхийн хамгийн том хот байсан',
          'Цаасан мөнгийг анх удаа өргөн хэрэглэсэн',
          'Марко Поло 17 жил Хубилай хааны дэргэд үйлчилсэн',
        ],
        'didYouKnow':
            'Хубилай хаан Японыг хоёр удаа (1274, 1281) довтлохоор далайн цэрэг илгээсэн боловч хоёр удаад хар салхи (камикадзе) хөлөг онгоцнуудыг сүйтгэсэн юм.',
        'timeline': [
          {'year': '1260', 'event': 'Хубилай Их хаан болсон'},
          {'year': '1271', 'event': 'Юань улсыг байгуулсан'},
          {'year': '1274', 'event': 'Японыг анх удаа довтолсон'},
          {'year': '1275', 'event': 'Марко Поло Хаанбалигт ирсэн'},
          {'year': '1279', 'event': 'Сүн гүрнийг бүрэн эзэлсэн'},
          {'year': '1294', 'event': 'Хубилай хаан нас барсан'},
          {'year': '1368', 'event': 'Юань улс мөхсөн, Мин гүрэн байгуулагдсан'},
        ],
      },
      {
        'id': 'story_5',
        ...
        'xpReward': 150,
        'quickFacts': [
          '13-р зуунд бичигдсэн Монголын хамгийн эртний уран зохиол',
          'ЮНЕСКО-гийн Дэлхийн баримтат өвд 2011 онд бүртгэгдсэн',
          'Хятад бичгээр хадгалагдаж, 20-р зуунд эргэн олдсон',
          '282 бүлгээс бүрдсэн цогц бүтээл',
        ],
        'didYouKnow':
            'Нууц товчоон дахь "нууц" гэдэг нь зөвхөн хааны гэр бүл, дотоод хүрээний хүмүүс уншихыг зөвшөөрдөг байснаас үүдэлтэй. Хятадын Мин гүрний үед энэ бичгийг хятад бичигт хөрвүүлэн хадгалснаар өнөөг хүртэл хадгалагджээ.',
        'timeline': [
          {'year': '1228', 'event': 'Нууц товчоо бичигдсэн гэж үздэг'},
          {'year': '1240', 'event': 'Өгөдэй хааны үед нэмэлт бичвэр оруулсан'},
          {'year': '14–15 зуун', 'event': 'Хятад бичигт хөрвүүлэгдсэн'},
          {'year': '1866', 'event': 'Оросын эрдэмтэд анх судалж эхэлсэн'},
          {'year': '2011', 'event': 'ЮНЕСКО-гийн баримтат өвд бүртгэгдсэн'},
        ],
      },
    ];
    ...
    for (final s in stories) {
      ...
      batch.set(ref, {
        ...
        'order': s['order'],
        'xpReward': s['xpReward'],
        'quickFacts': s['quickFacts'],
        'didYouKnow': s['didYouKnow'],
        'timeline': s['timeline'],
      });
    }
